...
BOOST_AUTO_TEST_CASE(no_sensor_test)
{
...
BOOST_AUTO_TEST_CASE(one_sensor_test)
{
...
BOOST_AUTO_TEST_CASE(one_nostop_sensor_test)
{
...
//BOOST_AUTO_TEST_CASE(two_sensor_test)
//{
//	sensor_manager.setOutStream(std::cout);
//	sensor_manager.addSensor(0xAAAA, true );
//	sensor_manager.setConversionFactors(0xAAAA,2.5,70);
//	sensor_manager.addSensor(0xBBBB, true );
//	sensor_manager.setConversionFactors(0xBBBB,1.5,-70);
//
//	std::this_thread::sleep_for(std::chrono::milliseconds(5500));
//	sensor_manager.stop();
//}
